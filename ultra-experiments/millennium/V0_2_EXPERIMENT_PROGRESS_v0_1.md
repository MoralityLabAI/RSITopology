...
| ASMP-9 reward-gauge access | completed exact loop-return census, ordinal successor, two sharp-width theorems, and a finite-sample stochastic-channel theorem | exact real-valued cycle queries recover the potential-shaping quotient; v0.3.1 and v0.4 prove the positive-ambiguity and exact-tie width laws; v0.5.1 shows the exact width remains a finite-sample liveness boundary under a known noisy sign-and-tie channel and proves a quadratic nonadaptive versus logarithmic-depth adaptive Farey separation; discounted shaping, behavioral access, unknown response parameters, and inconsistent demonstrators remain open |
