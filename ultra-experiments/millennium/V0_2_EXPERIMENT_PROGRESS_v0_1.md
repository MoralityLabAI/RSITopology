...
| ASMP-9 reward-gauge access | completed exact loop-return census, ordinal-access successor, and corrected sharp-width theorem | exact real-valued cycle queries recover the potential-shaping quotient; the ordinal successor separates query count from coefficient width; v0.3.1 proves the sharp robust width `2` at `B=1` and `2B-1` thereafter for `0<delta<1`, while preserving the failed v0.3 endpoint claim; behavioral, discounted, and finite-sample identification remain open |
