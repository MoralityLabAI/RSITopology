...
SEALED_NAMES = (
    "DEVELOPMENT_CENSUS_v0_15.json",
    "DEVELOPMENT_NOTE_v0_15.md",
    "DEVELOPMENT_RECEIPT_v0_15.json",
    "PRIOR_ART_GATE_v0_15.md",
    "PROTOCOL_v0_15.md",
    "README.md",
    "THEOREM_DRAFT_v0_15.md",
    "THEOREM_v0_15.md",
    "development_census.py",
    "environment_v0_15.json",
    "experiment.py",
    "protocol_v0_15.json",
    "register.py",
    "run_verification.py",
...
def main() -> None:
    ...
    protocol_path = HERE / "protocol_v0_15.json"
    registration = {
        "registration_id": (
            "ASMP-9-SHARP-INTERIOR-AVAILABILITY-v0.15-registration"
        ),
