...
Status: **development only; unregistered and unverified**.
...
The exact code checks the linear-algebra and dimension ingredients for
`n = 3, 4, 5` and exhausts every proper menu domain for `n = 3, 4`.
It is evidence about the implementation of the proof, not a substitute for
the arbitrary-`n` argument.
