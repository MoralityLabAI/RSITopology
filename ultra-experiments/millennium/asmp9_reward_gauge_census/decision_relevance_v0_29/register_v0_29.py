...
REPO = HERE.parents[3]
SEALED_NAMES = (
    "DEVELOPMENT_NOTE_v0_29.md",
    "PRIOR_ART_GATE_v0_29.md",
    "README.md",
    "THEOREM_DRAFT_v0_29.md",
    "__init__.py",
    "decision_relevance.py",
    "environment_lock_v0_29.json",
    "protocol_v0_29.json",
    "register_v0_29.py",
    "run_verification_v0_29.py",
    "test_decision_relevance.py",
    "test_protocol_v0_29.py",
    "verify_result_v0_29.py",
)
...
def main() -> None:
    ...
    registration = {
        ...
        "protocol_path": (HERE / "protocol_v0_29.json")
        .relative_to(REPO)
        .as_posix(),
        "registered_at_utc": utc_now(),
        "registration_id": "ASMP-9-DECISION-RELEVANCE-v0.29-registration",
        "sealed_files": sealed,
    }
