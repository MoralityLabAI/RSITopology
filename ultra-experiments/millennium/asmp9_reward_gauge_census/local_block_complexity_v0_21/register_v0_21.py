...
LOCAL_NAMES = (
    "DEVELOPMENT_NOTE_v0_21.md",
    "PRIOR_ART_GATE_v0_21.md",
    "PROTOCOL_v0_21.md",
    "README.md",
    "THEORY_DRAFT_v0_21.md",
    "burned_graph_registry_v0_21.json",
    "local_block_complexity.py",
    "make_burned_graph_registry_v0_21.py",
    "protocol_v0_21.json",
    "register_v0_21.py",
    "run_verification_v0_21.py",
    "test_local_block_complexity.py",
    "test_protocol_v0_21.py",
    "verify_result_v0_21.py",
)
...
DEPENDENCIES = (
    ...
    "ultra-experiments/millennium/asmp9_reward_gauge_census/"
    "general_graph_design_v0_17/protocol_v0_17.json",
    "ultra-experiments/millennium/asmp9_reward_gauge_census/"
    "block_factorization_v0_20/protocol_v0_20.json",
    "ultra-experiments/millennium/asmp9_reward_gauge_census/"
...
def main() -> None:
    ...
    registration = {
        ...
        .replace("+00:00", "Z"),
        "registration_id": (
            "ASMP-9-LOCAL-BLOCK-COMPLEXITY-v0.21-registration"
        ),
        "sealed_files": sealed,
    }
