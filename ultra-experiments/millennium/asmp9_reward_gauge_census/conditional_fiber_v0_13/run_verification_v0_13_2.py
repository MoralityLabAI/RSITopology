...
def render_report(result: dict[str, Any]) -> str:
    ...
    lines = [
        "# ASMP-9 conditional-fiber quotient verification v0.13.2",
        "",
...
def main() -> None:
    ...
    calibration = run_power_calibration_streaming_direct(
    ...
    verdict = (
        ...
        if all(gates.values())
        else "conditional_fiber_cycle_quotient_not_verified_v0_13_2"
    )
    result = {
    ...
    result_path = args.output_dir / "result_v0_13_2.json"
    report_path = args.output_dir / "RESULT_v0_13_2.md"
    ...
    write_json(args.output_dir / "receipt_v0_13_2.json", receipt)
