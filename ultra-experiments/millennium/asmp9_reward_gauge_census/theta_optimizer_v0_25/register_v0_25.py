...
DEPENDENCIES = (
    ...
    "nonuniform_multivariate_v0_23/nonuniform_multivariate.py",
    "ultra-experiments/millennium/asmp9_reward_gauge_census/"
    "nonuniform_multivariate_v0_23/registration_v0_23.json",
    "ultra-experiments/millennium/asmp9_reward_gauge_census/"
    "nonuniform_multivariate_v0_23/artifacts_v0_23/result_v0_23.json",
)
...
def main() -> None:
    ...
    registration = {
        ...
        "protocol_path": (
            HERE / "protocol_v0_25.json"
        ).relative_to(REPO).as_posix(),
        "registered_at_utc": utc_now(),
        "registration_id": (
            "ASMP-9-THETA-OPTIMIZER-v0.25-registration"
        ),
        "sealed_files": sealed,
    }
