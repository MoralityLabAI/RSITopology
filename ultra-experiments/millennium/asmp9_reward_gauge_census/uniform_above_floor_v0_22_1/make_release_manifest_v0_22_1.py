...
REPO = HERE.parents[3]
PREDECESSOR = HERE.parent / "uniform_above_floor_v0_22"
AUDIT = HERE.parent / "RESOLUTION_AUDIT_v0_22_1.md"
PROGRESS = REPO / (
...
def main() -> None:
    ...
    files.extend((AUDIT, PROGRESS, FELLOWSHIP))
    ...
    manifest = {
        ...
        "release_id": "ASMP-9-UNIFORM-ABOVE-FLOOR-v0.22.1-release",
        "scope": (
            "failed v0.22 predecessor, registered v0.22.1 successor, "
            "result chain, resolution audit, progress map, and fellowship "
            "dossier"
        ),
    }
