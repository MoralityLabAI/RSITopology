...
LOCAL_NAMES = (
    "DEVELOPMENT_NOTE_v0_26.md",
    "PRIOR_ART_GATE_v0_26.md",
    "README.md",
    "THEOREM_DRAFT_v0_26.md",
    "environment_lock_v0_26.json",
    "offset_access.py",
    "protocol_v0_26.json",
    "register_v0_26.py",
    "run_verification_v0_26.py",
    "test_offset_access_v0_26.py",
    "test_protocol_v0_26.py",
    "verify_result_v0_26.py",
)

DEPENDENCIES = (
    "ultra-experiments/millennium/asmp9_reward_gauge_census/"
    "unknown_link_v0_8/PUBLIC_SUMMARY_v0_8.md",
    "ultra-experiments/millennium/asmp9_reward_gauge_census/"
    "unknown_link_v0_8/verification_v0_8.json",
)
...
def main() -> None:
    ...
    registration = {
        ...
        "protocol_path": (HERE / "protocol_v0_26.json")
        .relative_to(REPO)
        .as_posix(),
        "registered_at_utc": utc_now(),
        "registration_id": "ASMP-9-OFFSET-ACCESS-v0.26-registration",
        "sealed_files": sealed,
    }
