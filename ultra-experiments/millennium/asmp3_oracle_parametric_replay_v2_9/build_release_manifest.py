...
MANIFEST_PATH = HERE / "RELEASE_MANIFEST_v2_9.json"
RELEASE_FILES = (
    ...
    ".gitignore",
    "README.md",
    "ORACLE_PARAMETRIC_REPLAY_THEOREM_v2_9.md",
    "COMPLETION_AUDIT_v2_9.md",
    "oracle_parametric_replay.py",
    "run_oracle_parametric_replay.py",
    "verify_oracle_parametric_replay.py",
    "test_oracle_parametric_replay.py",
...
def build_manifest() -> dict[str, object]:
    ...
    return {
        "schema_version": "asmp3_oracle_parametric_replay_release_v2_9",
        "experiment_id": "ASMP-3-ORACLE-PARAMETRIC-REPLAY-v2.9",
        "release_status": "oracle_parametric_ideal_replay_compiler_with_transcript_firewall",
        "deterministic": True,
...
def main() -> None:
    ...
    if not verify_manifest():
        raise RuntimeError("ASMP-3 v2.9 manifest self-check failed")
    print(f"ASMP-3 v2.9 release manifest sealed: {len(RELEASE_FILES)} files")
